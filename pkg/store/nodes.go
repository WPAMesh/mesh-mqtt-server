...
func (b *postgresNodeInfoStore) SaveInfo(nodeInfo *models.NodeInfo) error {
	...
	VALUES (:node_id, :user_id, :long_name, :short_name, :node_role, :primary_channel, :latitude, :longitude, :last_seen, :last_verified)
	...
	DO UPDATE
	  SET long_name = :long_name,
		  ...
		  latitude = COALESCE(:latitude, node_info.latitude),
		  longitude = COALESCE(:longitude, node_info.longitude),
		  last_seen = :last_seen,
