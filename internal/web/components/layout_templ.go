...
func Layout(props LayoutProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"wrapper\"><header class=\"flex items-center w-full py-4 gap-4 flex-wrap\"><div class=\"logo-view flex-grow min-w-0\"><a href=\"/\" class=\"flex items-center gap-2\"><img class=\"logo w-16 md:w-24 flex-shrink-0\" src=\"/static/pgh_mesh_nobg.svg\" alt=\"Pittsburgh Mesh Logo\"> <span class=\"font-light whitespace-nowrap\">MQTT Server</span></a></div><nav id=\"header-nav\" class=\"hidden md:block\"><ul class=\"flex flex-row gap-1 text-sm lg:text-base\" data-toggle=\"nav\"><li class=\"px-2 py-1 lg:px-3 lg:py-2\"><a href=\"/\" class=\"hover:text-primary\">My Nodes</a></li>")
		if templ_7745c5c3_Err != nil {
		...
		if props.IsSuperuser || props.IsAdmin {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<li><a href=\"/all-nodes\" class=\"block py-2 px-3 hover:bg-quaternary rounded\">All Nodes</a></li><li><a href=\"/map\" class=\"block py-2 px-3 hover:bg-quaternary rounded\">Map</a></li><li><a href=\"/users\" class=\"block py-2 px-3 hover:bg-quaternary rounded\">Users</a></li><li><a href=\"/blocked-nodes\" class=\"block py-2 px-3 hover:bg-quaternary rounded\">Blocked Nodes</a></li>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		for i, a := range props.Alerts {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/layout.templ`, Line: 62, Col: 96}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/layout.templ`, Line: 63, Col: 40}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "</div><footer class=\"p-4 text-center text-tertiary\"><a href=\"https://github.com/WPAMesh/mesh-mqtt-server\" class=\"text-primary hover:underline\">Github</a> | made by <a href=\"https://github.com/kabili207\">kabili207</a> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/components/layout.templ`, Line: 75, Col: 175}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, " <a href=\"https://www.wpamesh.com/\">Western PA Mesh</a></footer></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
